<?php
/* Smarty version 3.1.45, created on 2022-08-05 06:18:59
  from 'C:\xampp\htdocs\buku_tamu_gagal\app\templates\index.html' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.45',
  'unifunc' => 'content_62ec9a33d9f4c4_65649284',
...
function content_62ec9a33d9f4c4_65649284 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
 ...
 type="text/javascript">
        ...
        function authenticateUser() {
            ...
            faceio.authenticate({
                ...
                const dataImg = JSON.stringify(userData.payload.image).replace(/"/g,"")
                document.location.pathname = `/guest/${dataImg}`;
                ...
                case fioErrCode.WRONG_PIN_CODE:
                    ...
                    Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                document.location.pathname = `/verifikasi`;
                            }else {
